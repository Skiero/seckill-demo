...
public class TestDemo {
    public static void main(String[] args) {
        ...
        long count3 = strings.stream().filter(string -> string.length() == 3).count();
        System.out.println("count3:" + count3);
        count = strings.stream().filter(string -> string.length() == 3).count();
        System.out.println("字符串长度为 3 的数量为: " + count);
        long count4 = strings.stream().filter(string -> !string.isEmpty()).count();
        ...
        System.out.println("-----------------------------------------------------");
        List<Integer> collect1 = integers.stream().map(integer -> integer * integer).distinct().collect(Collectors.toList());
        System.out.println("collect1" + collect1);
        List<Integer> collect2 = numbers.stream().map(integer -> integer * integer).collect(Collectors.toList());
...
//        IntSummaryStatistics intSummaryStatistics = integers.stream().mapToInt(x -> x).summaryStatistics();
        DoubleSummaryStatistics intSummaryStatistics = integers.stream().mapToDouble(x -> x).summaryStatistics();
        ...
        System.out.println("随机数: ");
        random.ints().limit(10).sorted().forEach(s -> System.out.println(s));
        long count5 = strings.stream().filter(s -> s.isEmpty()).count();
